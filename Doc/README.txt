...
- Modified test to support new API interface. The output of API Tweet_Service.getRecentTweets is changed from a activeRelation to ruby array with 3 attribute standing for user_name,text,time in word.